...
function Moonphase() {
    ...
    return (
        <div className={styles.container}>
            <img className="moonimage" style={{height: '65px', width: '65px', margin: 'auto', display: 'flex', justifyContent: 'left', padding: '18px'}}
            ...
            <p style={{fontSize: '15px', textAlign: 'center'}}>{moon_phase_recommendations((data.daily[0].moon_phase) * 100)}</p>
        </div>
    );
}
